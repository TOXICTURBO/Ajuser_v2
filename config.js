...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Toxic public bot' : process.env.ALL_CAPTION,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '916380260672@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'Toxic Bot' : process.env.BOT_NAME,
    ...
    RASHI: process.env.LOGO_LINK === undefined ? 'https://telegra.ph/file/514df658f7582f9f07209.jpg' : process.env.LOGO_LINK,
    ...
    MAHN: process.env.MAAN === undefined ? '916380260672,0' : process.env.MAAN,
    BRANCH: 'master',
    HEROKU: {
